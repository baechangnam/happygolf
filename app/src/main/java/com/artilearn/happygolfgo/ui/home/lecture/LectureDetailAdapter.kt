...
class LectureDetailAdapter(
    ...
    private val lectureItemClicks: LectureDetailActivity.LectureItemClick,
    val tag : String
) : RecyclerView.Adapter<LectureDetailAdapter.TrainingListViewHolder>() {

    class TrainingListViewHolder(
        private val binding: ItemHomeLectureListBinding,
        override val lectureItemClick: LectureDetailActivity.LectureItemClick,
        ...
        override fun bind(item: Lecture) {
            ...
            binding.llFavor.setOnClickListener {
                lectureItemClick?.itemClick(adapterPosition , "bookmark" ,tags)
            }

            binding.root.setOnClickListener {
                lectureItemClick?.itemClick(adapterPosition, "detail", tags)
            }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TrainingListViewHolder {
        ...
        return TrainingListViewHolder(binding,lectureItemClicks,tag)
    }
