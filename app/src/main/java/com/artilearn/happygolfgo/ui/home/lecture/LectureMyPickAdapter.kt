...
class LectureMyPickAdapter(
    private val itemList: List<Lecture>,
    private val lectureItemClicks: LectureMyPickActivity.LectureItemClick
) : RecyclerView.Adapter<LectureMyPickAdapter.TrainingListViewHolder>() {

    class TrainingListViewHolder(
        private val binding: ItemSectLectureListBinding, override val lectureItemClick: LectureMyPickActivity.LectureItemClick,
