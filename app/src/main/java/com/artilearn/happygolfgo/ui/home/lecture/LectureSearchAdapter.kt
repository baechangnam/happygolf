...
class LectureSearchAdapter(
    private val itemList: List<Lecture>,
    private val lectureItemClicks: LectureSearchActivity.LectureItemClick
) : RecyclerView.Adapter<LectureSearchAdapter.TrainingListViewHolder>() {

    class TrainingListViewHolder(
        private val binding: ItemSectLectureListBinding, override val lectureItemClick: LectureSearchActivity.LectureItemClick,
